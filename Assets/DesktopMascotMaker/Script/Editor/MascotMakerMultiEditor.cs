...
namespace DesktopMascotMaker
{
    ...
    public class MascotMakerMultiEditor : Editor
    {
        ...
        GUIContent gcUpdateFunc = new GUIContent("Update Function", "Which update function to use. In most cases, Update is OK. Only when the rendering is not good, try LateUpdate.");
        ...
        public override void OnInspectorGUI()
        {
            ...
            mascotMakerMulti.UpdateFunc = (MascotMakerMulti.UpdateFuncType)EditorGUILayout.EnumPopup(gcUpdateFunc, mascotMakerMulti.UpdateFunc);
