namespace DesktopMascotMaker
{
    ...
    [RequireComponent(typeof(MeshRenderer)), RequireComponent(typeof(Camera)), AddComponentMenu("DesktopMascotMaker/MascotMaker")]
    public class MascotMaker : MonoBehaviour
    {
        ...
        {          
            if (this.GetComponent<DMMOrbitalViewCamera>().count == 2)
            {
            ...
            else if(this.GetComponent<DMMOrbitalViewCamera>().count == 1)
            {
                this.GetComponent<TimeManage>().JSButtonOneDown();
            }
            else if (this.GetComponent<DMMOrbitalViewCamera>().count == 3)
            {
            ...
            else if (this.GetComponent<DMMOrbitalViewCamera>().count == 4)
            {
               this.GetComponent<DMMOrbitalViewCamera>().Pcount -= 1;
                if (this.GetComponent<DMMOrbitalViewCamera>().Pcount < 0)
                {
                    this.GetComponent<DMMOrbitalViewCamera>().Pcount = 7;
                }
                string FilePath = "";
                ...
                {
                    FilePath = $"{System.Environment.CurrentDirectory}" + string.Format("\\WPManage\\{0}.jpg", this.GetComponent<DMMOrbitalViewCamera>().Pcount);
                }
        ...
        public static MascotMaker Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = FindObjectOfType(typeof(MascotMaker)) as MascotMaker;
                    if (instance == null)
                    {
        ...
        public int Opacity
        {
            get => 
                this.opacity;
            set => this.opacity = (byte)Mathf.Clamp(value, 0, 0xff);
        }
