...
public class DMMOrbitalViewCameraEditor : Editor
{
    ...
    GUIContent gcCount = new GUIContent("count", "count");
    GUIContent gcInfoText = new GUIContent("text", "text");
    ...
    public override void OnInspectorGUI()
    {
        ...
        orbitalViewCamera.count = EditorGUILayout.IntField(gcCount, orbitalViewCamera.count);
        orbitalViewCamera.infotext = EditorGUILayout.ObjectField(gcInfoText,orbitalViewCamera.infotext,typeof(Text),true)as Text;
